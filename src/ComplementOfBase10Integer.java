...
public class ComplementOfBase10Integer {
    ...
    public int bitwiseComplement(int N) {
        ...
        String bin = Integer.toBinaryString(N^(Integer.valueOf(new String(stringBuilder),2)));
        return Integer.valueOf(bin,2);
    }

    //优秀解答
    public int bitwiseComplement2(int num) {
        int len = Integer.toBinaryString(num).length();
        return Integer.parseInt(Integer.toBinaryString(~num).substring(32 - len), 2);
    }
